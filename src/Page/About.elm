...
view close =
    div [ class "about" ]
        ...
        , ul []
            ...
            , feature "Khi chạy: trạm kế tiếp còn bao xa, leo bao nhiêu, xuống bao nhiêu, còn bao lâu tới giờ đóng trạm — và toàn bộ chặng. Màn hình chạy mở sẵn tab Định vị."
            , feature "Sơ đồ đường chạy vẽ từ file GPX, không cần mạng: đoạn đã qua màu xám, đoạn còn phải chạy màu cam. Chỗ đường chạy đi qua hai lần, đoạn còn phải chạy nằm trên và có viền xám để biết mình đã qua đó một lần."
            , feature "Mũi tên chỉ hướng chạy cho đoạn phía trước bạn (mặc định 500 m, gõ số khác vào ô dưới sơ đồ nếu muốn), nên đoạn vòng hay đoạn đi-về trùng vệt vẫn biết phải đi lối nào."
